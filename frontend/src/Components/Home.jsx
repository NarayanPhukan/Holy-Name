    ...
    <div className="bg-surface relative">
      ...
      <main className="relative">
        ...
        <div className="w-full flex justify-center py-2 px-5 bg-secondary-container text-on-secondary-container rounded-b-xl shadow-sm mb-4">
          <p className="text-xs font-bold tracking-widest uppercase whitespace-nowrap marquee">
        ...
        {/* Hero Section */}
        <section className="relative w-full h-[600px] lg:h-[716px] flex items-center overflow-hidden bg-primary-container rounded-3xl mx-auto max-w-[98%] shadow-2xl">
            ...
            {images.map((img, idx) => (
              <img
                ...
                className={`w-full h-full object-cover transition-opacity duration-1000 ease-in-out absolute inset-0 ${
                  idx === currentIndex ? "opacity-30 mix-blend-overlay" : "opacity-0"
                }`}
              />
            ))}
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary-container/20 text-secondary border border-secondary/30">
                ...
                <span className="text-xs font-bold tracking-[0.2em] uppercase">Established 1985</span>
              </div>
              <h2 className="font-['Noto_Serif'] text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tighter">
                Nurturing the <span className="text-secondary-container italic">Leaders</span> of Tomorrow.
              </h2>
              <p className="text-primary-fixed text-base md:text-lg max-w-xl font-medium leading-relaxed">
                Holy Name Senior Secondary School offers a transformative academic journey that bridges traditional values with futuristic learning architectures.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                <Link to="/admission" className="bg-secondary-container text-on-secondary-container font-bold px-8 py-4 rounded-xl flex items-center gap-3 hover:-translate-y-1 transition-all duration-300 shadow-xl shadow-primary/20">
                  Apply for Admission
                  <span className="material-symbols-outlined">arrow_forward</span>
                </Link>
                <Link to="/courses" className="bg-white/10 backdrop-blur-md text-white border border-white/20 font-bold px-8 py-4 rounded-xl hover:bg-white/20 transition-all duration-300">
                  Explore Curriculum
                </Link>
              </div>
            </div>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4 h-[500px]">
              <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-6 flex flex-col justify-end border border-white/10 hover:bg-white/10 transition-all">
                ...
                <h4 className="text-white font-bold text-xl uppercase tracking-wider">Advanced Labs</h4>
                <p className="text-primary-fixed/80 text-sm mt-2">Equipped with the latest research technologies.</p>
              </div>
              <div className="bg-secondary-container rounded-3xl p-6 flex flex-col justify-between hover:scale-[1.02] transition-all">
                ...
                <h4 className="text-primary font-bold text-xl uppercase tracking-wider leading-none">Top Rated School</h4>
              </div>
              <div className="col-span-2 bg-white/5 backdrop-blur-lg rounded-3xl p-6 flex items-center gap-6 border border-white/10">
                ...
                <div>
                  <h4 className="text-white font-bold text-lg uppercase tracking-wider">Rich Heritage</h4>
                  <p className="text-primary-fixed/80 text-sm">38 years of academic excellence in Sivasagar.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-surface">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center space-y-2 p-8 rounded-3xl bg-surface-container-low border border-outline-variant/30 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
              <div className="text-4xl font-black text-primary academic-serif">2.5k+</div>
              <div className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Students Enrolled</div>
            </div>
            <div className="text-center space-y-2 p-8 rounded-3xl bg-surface-container-low border border-outline-variant/30 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
              <div className="text-4xl font-black text-primary academic-serif">150+</div>
              <div className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Expert Faculty</div>
            </div>
            <div className="text-center space-y-2 p-8 rounded-3xl bg-surface-container-low border border-outline-variant/30 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
              <div className="text-4xl font-black text-primary academic-serif">40+</div>
              <div className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Laboratories</div>
            </div>
            <div className="text-center space-y-2 p-8 rounded-3xl bg-surface-container-low border border-outline-variant/30 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
              <div className="text-4xl font-black text-primary academic-serif">100%</div>
              <div className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Pass Result</div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 my-10">
          <div className="bg-gradient-to-br from-surface-container-high to-surface-container-highest rounded-3xl shadow-lg p-12 md:p-20 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-primary via-secondary to-primary"></div>
            <span className="material-symbols-outlined text-primary/10 text-9xl absolute -bottom-10 -right-10 pointer-events-none">school</span>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-20 py-10">
          <section className="bg-surface-container-low rounded-3xl p-8 md:p-12 border border-outline-variant/30">
            <h3 className="academic-serif text-3xl font-black mb-10 text-primary text-center">Campus Amenities</h3>
            <Items />
          </section>
          ...
          <section className="bg-primary-container text-on-primary rounded-3xl p-8 md:p-12 overflow-hidden shadow-2xl">
            <VideoBlogSection />
          </section>
